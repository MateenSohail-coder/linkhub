...
export default function Navbar() {
  ...
  return (
    <div className="flex items-center justify-center w-full">
      <nav
        className={`flex bg-white items-center top-15 z-50 fixed transition-all duration-900 justify-between w-[90%] py-2 md:py-2.5 px-5 md:px-10 rounded-full mx-auto`}
      >
        <Link href="/">
        ...
        <div className="buttons flex gap-3 items-center">
         <Link href="/generate">
          <button className=" cursor-pointer font-semibold text-[12px] md:text-sm hover:bg-neutral-200 bg-neutral-100 px-4 md:px-4 h-auto rounded py-2 md:py-4">
            Log in
          </button></Link>
          <Link href="/generate">
